...
_HARD_RULES_KEYS = [
    ...
    'MAX_LOTS_PER_TRADE', 'LIQ_GATE_MAX_SPREAD_PCT', 'LIQ_GATE_MIN_TOP3_DEPTH_RATIO', 'LIQ_GATE_MAX_SLIPPAGE_PCT',
    'REV_GATE_MAX_SPREAD_PCT', 'REV_GATE_HARD_SPREAD_PCT', 'SPIRAL_MAX_REVERSES', 'SPIRAL_WINDOW_SECS', 'SPIRAL_BLOCK_DURATION_SECS',
]
